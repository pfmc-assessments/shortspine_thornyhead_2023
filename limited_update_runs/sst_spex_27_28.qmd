...
This document details new projections for `r species` based on the 2026 catch-only projection adopted by the Council (G.8 Attachment 2, Table 3 from the September, 2025 Council meeting). The specifications through 2026 remain unchanged. The ABC and ACL for 2027 and 2028 are all assumed to be 902 mt. Relative allocations among the three fleets are assumed the same as the GMT projected relative allocations for 2025 and 2026.
