...
# Path to the base model (23.blkret.T3.blksel.T3) repertory
Dir_23_blkret_T3_blksel_T3 <- file.path(dirname(dir_SensAnal), '5.11_Selectivity_Sensitivity', '7_23.blkret.T3.blksel.T3', 'run', fsep = fsep)

# Root directory for this sensitivity analysis
SA_path <- file.path('model','Sensitivity_Anal','STAR_Panel','5.14_Request_4',fsep = fsep)

# Path to the 23.est.max.ret repertory
Dir_23_est_max_ret <- file.path(dir_SensAnal, '5.14_Request_4','1_23.est.max.ret' , 'run',fsep = fsep)
