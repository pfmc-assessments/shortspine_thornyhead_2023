...
# /Users/jzahner/Desktop/Projects/shortspine_thornyhead_2023/R/ss/Sensitivity_Anal/5.17_Recruitment_Requests_Outputs.R 
...
#  3. Developing model 23.model.rec_biasadj  ----
# ----------------------------------------------------------- #

# Path to the 23.model.rec_biasadj repertory
Dir_23_model_rec_biasadj <- file.path(dir_SensAnal, '5.17_Recruitment_Requests','1_23.model.rec_biasadj' ,fsep = fsep)

# Add the model directory to the saved variables
var.to.save <- c(var.to.save, 'Dir_23_model_rec_biasadj') 


# For each SS input file, the following variable names will be used:
# Starter file :			 Start23_model_rec_biasadj 
# Data file :			 Dat23_model_rec_biasadj 
# Control file :			 Ctl23_model_rec_biasadj 
# Forecast file :			 Fore23_model_rec_biasadj 
...
Restart_SA_modeldvpt(
      ...
      curr.model = '23.model.rec_biasadj',
      files = 'all')
...
# ======================= #
# Read in the file
StarterFile <- file.path(Dir_23_model_rec_biasadj, 'starter.ss', fsep = fsep)
Start23_model_rec_biasadj <- SS_readstarter(
      file = StarterFile,
      verbose = TRUE
      )
...
SS_writestarter(
      mylist =  Start23_model_rec_biasadj ,
      dir =  Dir_23_model_rec_biasadj, 
      overwrite = TRUE,
      verbose = TRUE
      )

# Check file structure
# StarterFile <- file.path(Dir_23_model_rec_biasadj, 'starter.ss')
#  Start23_model_rec_biasadj <- SS_readstarter(
      # file = StarterFile,
      # verbose = TRUE
      # )
...
# clean environment
var.to.save <- c(var.to.save, 'Start23_model_rec_biasadj')
...
# ======================= #
# Read in the file
DatFile <-file.path(Dir_23_model_rec_biasadj,Start23_model_rec_biasadj$datfile, fsep = fsep)
Dat23_model_rec_biasadj <- SS_readdat_3.30(
      file = DatFile,
      verbose = TRUE,
      section = TRUE
      )
...
SS_writedat(
      datlist =  Dat23_model_rec_biasadj ,
      outfile = file.path(Dir_23_model_rec_biasadj, 'SST_data.ss', fsep = fsep),
      version = '3.30',
      overwrite = TRUE
      )

# Check file structure
# DatFile <- file.path(Dir_23_model_rec_biasadj, 'SST_data.ss', fsep = fsep)
#  Dat23_model_rec_biasadj <-
      # SS_readdat_3.30(
      # file = DatFile,
      # verbose = TRUE,
      # section = TRUE
...
# clean environment
var.to.save <- c(var.to.save, 'Dat23_model_rec_biasadj')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# Read in the file
Ctlfile <-file.path(Dir_23_model_rec_biasadj,Start23_model_rec_biasadj$ctlfile, fsep = fsep)
Ctl23_model_rec_biasadj <- SS_readctl_3.30(
      file = Ctlfile,
      use_datlist = TRUE,
      datlist = file.path(Dir_23_model_rec_biasadj, 'run','data_echo.ss_new', fsep = fsep),
      verbose = TRUE
      )
...
# ..... 
# ..... 
Ctl23_model_rec_biasadj$max_bias_adj <- 0.30

# Save the control file for the model
SS_writectl(
      ctllist =  Ctl23_model_rec_biasadj ,
      outfile = file.path(Dir_23_model_rec_biasadj, 'SST_control.ss', fsep = fsep),
      version = '3.30',
      overwrite = TRUE
      )
# Check file structure
...
# clean environment
var.to.save <- c(var.to.save, 'Ctl23_model_rec_biasadj')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# Read in the file
ForeFile <- file.path(Dir_23_model_rec_biasadj, 'forecast.ss', fsep = fsep)
Fore23_model_rec_biasadj <-SS_readforecast(
      file = ForeFile,
      version = '3.30',
      verbose = T,
      readAll = T
...
SS_writeforecast(
      mylist =  Fore23_model_rec_biasadj ,
      dir = Dir_23_model_rec_biasadj, 
      file = 'forecast.ss',
      writeAll = TRUE,
      verbose = TRUE,
...
# clean environment
var.to.save <- c(var.to.save, 'Fore23_model_rec_biasadj')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
Dirplot <- file.path(Dir_23_model_rec_biasadj, 'run', fsep = fsep)
...
# End development for model 23.model.rec_biasadj 
# You can now develop the next 'new model'.
# Let's remove the input files for this from the 'var.to.save' variable
var.to.save <- var.to.save[!var.to.save %in% c('Start23_model_rec_biasadj','Dat23_model_rec_biasadj','Ctl23_model_rec_biasadj','Fore23_model_rec_biasadj')]
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
...
#  4. Developing model 23.model.rec_main_period  ----
# ----------------------------------------------------------- #

# Path to the 23.model.rec_main_period repertory
Dir_23_model_rec_main_period <- file.path(dir_SensAnal, '5.17_Recruitment_Requests','2_23.model.rec_main_period' ,fsep = fsep)

# Add the model directory to the saved variables
var.to.save <- c(var.to.save, 'Dir_23_model_rec_main_period') 


# For each SS input file, the following variable names will be used:
# Starter file :					 Start23_model_rec_main_period 
# Data file :					 Dat23_model_rec_main_period 
# Control file :					 Ctl23_model_rec_main_period 
# Forecast file :					 Fore23_model_rec_main_period 
...
Restart_SA_modeldvpt(
      base.model = '23.base.day2.update',
      curr.model = '23.model.rec_main_period',
      files = 'all')
...
# ======================= #
# Read in the file
StarterFile <- file.path(Dir_23_model_rec_main_period, 'starter.ss', fsep = fsep)
Start23_model_rec_main_period <- SS_readstarter(
      file = StarterFile,
      verbose = TRUE
      )
...
# Save the starter file for the model
SS_writestarter(
      mylist =  Start23_model_rec_main_period ,
      dir =  Dir_23_model_rec_main_period, 
      overwrite = TRUE,
      verbose = TRUE
      )

# Check file structure
# StarterFile <- file.path(Dir_23_model_rec_main_period, 'starter.ss')
#  Start23_model_rec_main_period <- SS_readstarter(
      # file = StarterFile,
      # verbose = TRUE
      # )
...
# clean environment
var.to.save <- c(var.to.save, 'Start23_model_rec_main_period')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# ======================= #
# Read in the file
DatFile <-file.path(Dir_23_model_rec_main_period,Start23_model_rec_main_period$datfile, fsep = fsep)
Dat23_model_rec_main_period <- SS_readdat_3.30(
      file = DatFile,
      verbose = TRUE,
      section = TRUE
      )
...
# Save the data file for the model
SS_writedat(
      datlist =  Dat23_model_rec_main_period ,
      outfile = file.path(Dir_23_model_rec_main_period, 'SST_data.ss', fsep = fsep),
      version = '3.30',
      overwrite = TRUE
      )

# Check file structure
# DatFile <- file.path(Dir_23_model_rec_main_period, 'SST_data.ss', fsep = fsep)
#  Dat23_model_rec_main_period <-
      # SS_readdat_3.30(
      # file = DatFile,
      # verbose = TRUE,
      # section = TRUE
...
# clean environment
var.to.save <- c(var.to.save, 'Dat23_model_rec_main_period')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# Read in the file
Ctlfile <-file.path(Dir_23_model_rec_main_period,Start23_model_rec_main_period$ctlfile, fsep = fsep)
Ctl23_model_rec_main_period <- SS_readctl_3.30(
      file = Ctlfile,
      use_datlist = TRUE,
      datlist = file.path(Dir_23_model_rec_main_period, 'run','data_echo.ss_new', fsep = fsep),
      verbose = TRUE
      )
...
# ..... 
# ..... 
Ctl23_model_rec_main_period$max_bias_adj <- 0.30
Ctl23_model_rec_main_period$MainRdevYrLast <- 2012

# Save the control file for the model
SS_writectl(
      ctllist =  Ctl23_model_rec_main_period ,
      outfile = file.path(Dir_23_model_rec_main_period, 'SST_control.ss', fsep = fsep),
      version = '3.30',
      overwrite = TRUE
      )
# Check file structure
...
# clean environment
var.to.save <- c(var.to.save, 'Ctl23_model_rec_main_period')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# Read in the file
ForeFile <- file.path(Dir_23_model_rec_main_period, 'forecast.ss', fsep = fsep)
Fore23_model_rec_main_period <-SS_readforecast(
      file = ForeFile,
      version = '3.30',
      verbose = T,
      readAll = T
...
# Save the forecast file for the model
SS_writeforecast(
      mylist =  Fore23_model_rec_main_period ,
      dir = Dir_23_model_rec_main_period, 
      file = 'forecast.ss',
      writeAll = TRUE,
      verbose = TRUE,
...
# clean environment
var.to.save <- c(var.to.save, 'Fore23_model_rec_main_period')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
run_SS(SS_version = '3.30.21',
      # version of SS
      base_path =Dir_23_model_rec_main_period,
      # root directory where the input file are housed
      pathRun = NULL,
      # A 'run' folder is created if needed (where output files will be stored)
      copy_files = TRUE,
      # copy the input files from the23.model.rec_main_periodfolder
      cleanRun = TRUE,
      # clean the folder after the run
...
# ======================= #
# read the model output and print diagnostic messages
Dirplot <- file.path(Dir_23_model_rec_main_period, 'run', fsep = fsep)
...
# This can be done using the 5.17_Recruitment_Requests_Outputs.R script.
