...
surv_strat <- read.csv(tab_dir2, "SurveyStrat.csv", header = FALSE, stringsAsFactors = FALSE)
colnames(surv_strat) <- c("Survey", "Strata Definitions")

surv_strat$Survey <- gsub("\t", " ", table_data$Survey)
surv_strat$`Strata Definitions` <- gsub("\t", " ", surv_strat$`Strata Definitions`)
surv_strat$Survey <- gsub("\\s+", " ", table_data$Survey)
surv_strat$`Strata Definitions` <- gsub("\\s+", " ", surv_strat$`Strata Definitions`)
```
