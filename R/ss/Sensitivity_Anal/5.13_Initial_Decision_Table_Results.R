...
SA_path <- file.path('model','Sensitivity_Anal','5.13_Initial_Decision_Table',fsep = fsep)
# Path to the 23.decision.low repertory
Dir_23_decision_low <- file.path(dir_SensAnal, '5.13_Initial_Decision_Table','1_23.decision.low' , 'run',fsep = fsep)

# Path to the 23.decision.mid repertory
Dir_23_decision_mid <- file.path(dir_SensAnal, '5.13_Initial_Decision_Table','2_23.decision.mid' , 'run',fsep = fsep)

# Path to the 23.decision.high repertory
Dir_23_decision_high <- file.path(dir_SensAnal, '5.13_Initial_Decision_Table','3_23.decision.high' , 'run',fsep = fsep)
...
SS_decision_table_stuff(
  SensiMod$`23.decision.low`,
  yrs=2025:2032
)

SS_decision_table_stuff(
  SensiMod$`23.decision.mid`,
  yrs=2025:2032
)

SS_decision_table_stuff(
  SensiMod$`23.decision.high`,
  yrs=2025:2032
)
