...
SA_path <- file.path('model','Sensitivity_Anal','5.9_Retention_Selectivity_Sensitivity',fsep = fsep)
# Path to the 23.blkret.T1 repertory
Dir_23_blkret_T1 <- file.path(dir_SensAnal, '5.9_Retention_Selectivity_Sensitivity','1_23.blkret.T1' , 'run',fsep = fsep)

# Path to the 23.blkret.T2 repertory
Dir_23_blkret_T2 <- file.path(dir_SensAnal, '5.9_Retention_Selectivity_Sensitivity','2_23.blkret.T2' , 'run',fsep = fsep)
...
Dir_23_blkret_T4 <- file.path(dir_SensAnal, '5.9_Retention_Selectivity_Sensitivity','4_23.blkret.T4' , 'run',fsep = fsep)

# Path to the 23.blkret.T3.NT1 repertory
Dir_23_blkret_T3_NT1 <- file.path(dir_SensAnal, '5.9_Retention_Selectivity_Sensitivity','5_23.blkret.T3.NT1' , 'run',fsep = fsep)

# Path to the 23.blkret.T3.NT2 repertory
Dir_23_blkret_T3_NT2 <- file.path(dir_SensAnal, '5.9_Retention_Selectivity_Sensitivity','6_23.blkret.T3.NT2' , 'run',fsep = fsep)
