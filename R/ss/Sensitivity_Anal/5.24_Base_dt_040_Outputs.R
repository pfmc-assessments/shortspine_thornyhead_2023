...
SA_path <- file.path('model','Sensitivity_Anal','Base_Model','5.24_Decision_Table_040',fsep = fsep)

# Path to the 23.base.dt_base_40 repertory
Dir_23_base_dt_base_40 <- file.path(dir_SensAnal, '5.24_Decision_Table_040','1_23.base.dt_base_40' , 'run',fsep = fsep)

# Path to the 23.base.dt_low_40 repertory
Dir_23_base_dt_low_40 <- file.path(dir_SensAnal, '5.24_Decision_Table_040','2_23.base.dt_low_40' , 'run',fsep = fsep)

# Path to the 23.base.dt_high_40 repertory
Dir_23_base_dt_high_40 <- file.path(dir_SensAnal, '5.24_Decision_Table_040','3_23.base.dt_high_40' , 'run',fsep = fsep)

# Extract the outputs for all models
SensiMod <- SSgetoutput(dirvec = c(
	Dir_23_base_official,
	Dir_23_base_dt_base_40,
	Dir_23_base_dt_low_40,
	Dir_23_base_dt_high_40))
