...
## Data and assessment{-}
The most recent assessment for `r spp` was conducted in 2012 [@taylor_stephens_2013]. Stock status was determined to be above the management target and catches did not attain the full management limits, so reassessment of thornyheads has not been a higher priority. This assessment uses Stock Synthesis [@methot_stock_2013] Version 3.30.21, used in many other recent west coast assessments. 
...
6. Additional investigation into spatial stock structure could be valuable for determining whether future assessments should develop a spatial assessment model, or if `r spp` should be assessed at distinct spatial scales in the fut
