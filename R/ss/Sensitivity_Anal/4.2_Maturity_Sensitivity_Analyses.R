...
# basis of comparison.
Restart_SA_modeldvpt(base.model="23.base.official", curr.model="23.maturity.pgcurve", files="all", Overwrite.base = TRUE)
...
# to start again from scratch and get the same
# basis of comparison.
Restart_SA_modeldvpt(base.model="23.base.official", curr.model="23.maturity.mix_curve", files="all", Overwrite.base = TRUE)
