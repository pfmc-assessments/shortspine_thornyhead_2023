...
SA_path <- file.path('model','Sensitivity_Anal','STAR_Panel','5.18_SigmaR_non_sum_to_zero',fsep = fsep)

# Path to the 23.model.SigmaR.non.zero repertory
Dir_23_model_SigmaR_non_zero <- file.path(dir_SensAnal, '5.18_SigmaR_non_sum_to_zero','1_23.model.SigmaR.non.zero' , 'run',fsep = fsep)

# Extract the outputs for all models
SensiMod <- SSgetoutput(dirvec = c(
	Dir_23_base_day2_update,
	Dir_23_model_SigmaR_non_zero))
