...
# to start again from scratch and get the same
# basis of comparison.
Restart_SA_modeldvpt(base.model = "23.model.recdevs_bias", curr.model="23.model.fleetstruct_2", files="all")
...
Dat23_model_fleetstruct_2_save <- Dat23_model_fleetstruct_2

#Fleet Number (Nfleets!=Nfleet; Nfleets=Nfleet+NSurvey)
Dat23_model_fleetstruct_2$Nfleets <- SS_Param2023$Nfleets$data$ThreeFleets_UseSlope_CombineTriennial	

#Fleets Info
Dat23_model_fleetstruct_2$fleetinfo <- SS_Param2023$fleet_info$data$ThreeFleets_UseSlope_CombineTriennial	

#Areas 
Dat23_model_fleetstruct_2$areas <- SS_Param2023$areas$data$ThreeFleets_UseSlope_CombineTriennial	

#catch /!\ Mismatch in the name of this variable - Upper vs Lower case
Dat23_model_fleetstruct_2$catch <- SS_Param2023$Catch$data$ThreeFleets_UseSlope_CombineTriennial	

#CPUE info
Dat23_model_fleetstruct_2$CPUEinfo <- SS_Param2023$CPUEinfo$data$ThreeFleets_UseSlope_CombineTriennial	

#CPUE
Dat23_model_fleetstruct_2$CPUE <- SS_Param2023$Indices$data$ThreeFleets_UseSlope_CombineTriennial	

#NB DISCARD FLEETS
Dat23_model_fleetstruct_2$N_discard_fleets <- SS_Param2023$N_discard_fleets$data$ThreeFleets_UseSlope_CombineTriennial	

# DISCARD info
Dat23_model_fleetstruct_2$discard_fleet_info <- SS_Param2023$discard_fleet_info$data$ThreeFleets_UseSlope_CombineTriennial	

# Discard rates /!\ Mismatch in the name of this variable - discard_data vs discard_rates
Dat23_model_fleetstruct_2$discard_data <- SS_Param2023$discard_rates$data$ThreeFleets_UseSlope_CombineTriennial	


# Discard mean indiv weight /!\ Mismatch in the name of this variable - Upper vs Lower case
Dat23_model_fleetstruct_2$meanbodywt <- SS_Param2023$Meanbodywt$data$ThreeFleets_UseSlope_CombineTriennial	

# Info on length composition
Dat23_model_fleetstruct_2$len_info <- SS_Param2023$len_info$data$ThreeFleets_UseSlope_CombineTriennial	

# Length composition - includes fisheries, surveys, landings, discards
Dat23_model_fleetstruct_2$lencomp <- SS_Param2023$All_LengthComp$data$ThreeFleets_UseSlope_CombineTriennial	

# Number of Fishing fleets
Dat23_model_fleetstruct_2$Nfleet <- SS_Param2023$Nfleet$data$ThreeFleets_UseSlope_CombineTriennial	

# Number of Surveys
Dat23_model_fleetstruct_2$Nsurveys <- SS_Param2023$Nsurveys$data$ThreeFleets_UseSlope_CombineTriennial	
...
Ctl23_model_fleetstruct_2$size_selex_parms <- SS_Param2023$size_selex_parms$data$ThreeFleets_UseSlope_CombineTriennial	
Ctl23_model_fleetstruct_2$size_selex_parms_tv <- SS_Param2023$size_selex_parms_tv$data$ThreeFleets_UseSlope_CombineTriennial	

Ctl23_model_fleetstruct_2$Variance_adjustment_list <- SS_Param2023$Variance_adjustment_list$data$ThreeFleets_UseSlope_CombineTriennial	
...
# to start again from scratch and get the same
# basis of comparison.
Restart_SA_modeldvpt(base.model = "23.model.recdevs_bias", curr.model="23.model.fleetstruct_3", files="all")
...
Dat23_model_fleetstruct_3_save <- Dat23_model_fleetstruct_3

#Fleet Number (Nfleets!=Nfleet; Nfleets=Nfleet+NSurvey)
Dat23_model_fleetstruct_3$Nfleets <- SS_Param2023$Nfleets$data$FourFleets_UseSlope_CombineTriennial		

#Fleets Info
Dat23_model_fleetstruct_3$fleetinfo <- SS_Param2023$fleet_info$data$FourFleets_UseSlope_CombineTriennial		

#Areas 
Dat23_model_fleetstruct_3$areas <- SS_Param2023$areas$data$FourFleets_UseSlope_CombineTriennial		

#catch /!\ Mismatch in the name of this variable - Upper vs Lower case
Dat23_model_fleetstruct_3$catch <- SS_Param2023$Catch$data$FourFleets_UseSlope_CombineTriennial		

#CPUE info
Dat23_model_fleetstruct_3$CPUEinfo <- SS_Param2023$CPUEinfo$data$FourFleets_UseSlope_CombineTriennial		

#CPUE
Dat23_model_fleetstruct_3$CPUE <- SS_Param2023$Indices$data$FourFleets_UseSlope_CombineTriennial		

#NB DISCARD FLEETS
Dat23_model_fleetstruct_3$N_discard_fleets <- SS_Param2023$N_discard_fleets$data$FourFleets_UseSlope_CombineTriennial		

# DISCARD info
Dat23_model_fleetstruct_3$discard_fleet_info <- SS_Param2023$discard_fleet_info$data$FourFleets_UseSlope_CombineTriennial		

# Discard rates /!\ Mismatch in the name of this variable - discard_data vs discard_rates
Dat23_model_fleetstruct_3$discard_data <- SS_Param2023$discard_rates$data$FourFleets_UseSlope_CombineTriennial		


# Discard mean indiv weight /!\ Mismatch in the name of this variable - Upper vs Lower case
Dat23_model_fleetstruct_3$meanbodywt <- SS_Param2023$Meanbodywt$data$FourFleets_UseSlope_CombineTriennial		

# Info on length composition
Dat23_model_fleetstruct_3$len_info <- SS_Param2023$len_info$data$FourFleets_UseSlope_CombineTriennial		

# Length composition - includes fisheries, surveys, landings, discards
Dat23_model_fleetstruct_3$lencomp <- SS_Param2023$All_LengthComp$data$FourFleets_UseSlope_CombineTriennial		

# Number of Fishing fleets
Dat23_model_fleetstruct_3$Nfleet <- SS_Param2023$Nfleet$data$FourFleets_UseSlope_CombineTriennial		

# Number of Surveys
Dat23_model_fleetstruct_3$Nsurveys <- SS_Param2023$Nsurveys$data$FourFleets_UseSlope_CombineTriennial		

#max_combined_lbin
Dat23_model_fleetstruct_3$max_combined_lbin <- Dat23_model_fleetstruct_3$max_combined_lbin[-grep("slope|Non.trawl_S", colnames(Dat23_model_fleetstruct_3_save$fleetinfo1))]
...
Ctl23_model_fleetstruct_3$size_selex_parms <- SS_Param2023$size_selex_parms$data$FourFleets_UseSlope_CombineTriennial	
Ctl23_model_fleetstruct_3$size_selex_parms_tv <- SS_Param2023$size_selex_parms_tv$data$FourFleets_UseSlope_CombineTriennial	

Ctl23_model_fleetstruct_3$Variance_adjustment_list <- SS_Param2023$Variance_adjustment_list$data$FourFleets_UseSlope_CombineTriennial	
...
# Dont need t0 update forecast file when using four fleets
...
# to start again from scratch and get the same
# basis of comparison.
Restart_SA_modeldvpt(base.model="23.model.recdevs_bias", curr.model="23.model.fleetstruct_4", file="all")
...
# ..... 
# ..... 
Dat23_model_fleetstruct_4_save <- Dat23_model_fleetstruct_4

#Fleet Number (Nfleets!=Nfleet; Nfleets=Nfleet+NSurvey)
Dat23_model_fleetstruct_4$Nfleets <- SS_Param2023$Nfleets$data$FourFleets_NoSlope_CombineTriennial		

#Fleets Info
Dat23_model_fleetstruct_4$fleetinfo <- SS_Param2023$fleet_info$data$FourFleets_NoSlope_CombineTriennial		

#Areas 
Dat23_model_fleetstruct_4$areas <- SS_Param2023$areas$data$FourFleets_NoSlope_CombineTriennial		

#catch /!\ Mismatch in the name of this variable - Upper vs Lower case
Dat23_model_fleetstruct_4$catch <- SS_Param2023$Catch$data$FourFleets_NoSlope_CombineTriennial		

#CPUE info
Dat23_model_fleetstruct_4$CPUEinfo <- SS_Param2023$CPUEinfo$data$FourFleets_NoSlope_CombineTriennial		

#CPUE
Dat23_model_fleetstruct_4$CPUE <- SS_Param2023$Indices$data$FourFleets_NoSlope_CombineTriennial		

#NB DISCARD FLEETS
Dat23_model_fleetstruct_4$N_discard_fleets <- SS_Param2023$N_discard_fleets$data$FourFleets_NoSlope_CombineTriennial		

# DISCARD info
Dat23_model_fleetstruct_4$discard_fleet_info <- SS_Param2023$discard_fleet_info$data$FourFleets_NoSlope_CombineTriennial		

# Discard rates /!\ Mismatch in the name of this variable - discard_data vs discard_rates
Dat23_model_fleetstruct_4$discard_data <- SS_Param2023$discard_rates$data$FourFleets_NoSlope_CombineTriennial		


# Discard mean indiv weight /!\ Mismatch in the name of this variable - Upper vs Lower case
Dat23_model_fleetstruct_4$meanbodywt <- SS_Param2023$Meanbodywt$data$FourFleets_NoSlope_CombineTriennial		

# Info on length composition
Dat23_model_fleetstruct_4$len_info <- SS_Param2023$len_info$data$FourFleets_NoSlope_CombineTriennial		

# Length composition - includes fisheries, surveys, landings, discards
Dat23_model_fleetstruct_4$lencomp <- SS_Param2023$All_LengthComp$data$FourFleets_NoSlope_CombineTriennial		

# Number of Fishing fleets
Dat23_model_fleetstruct_4$Nfleet <- SS_Param2023$Nfleet$data$FourFleets_NoSlope_CombineTriennial		

# Number of Surveys
Dat23_model_fleetstruct_4$Nsurveys <- SS_Param2023$Nsurveys$data$FourFleets_NoSlope_CombineTriennial		

#max_combined_lbin
Dat23_model_fleetstruct_4$max_combined_lbin <- Dat23_model_fleetstruct_4$max_combined_lbin[-grep("slope|Non.trawl_S", colnames(Dat23_model_fleetstruct_4_save$fleetinfo1))]
...
Ctl23_model_fleetstruct_4$size_selex_parms <- SS_Param2023$size_selex_parms$data$FourFleets_NoSlope_CombineTriennial
Ctl23_model_fleetstruct_4$size_selex_parms_tv <- SS_Param2023$size_selex_parms_tv$data$FourFleets_NoSlope_CombineTriennial

Ctl23_model_fleetstruct_4$Variance_adjustment_list <- SS_Param2023$Variance_adjustment_list$data$FourFleets_NoSlope_CombineTriennial
...
# to start again from scratch and get the same
# basis of comparison.
Restart_SA_modeldvpt(base.model <- "23.model.recdevs_bias", curr.model="23.model.fleetstruct_5", files="all")
...
# ..... 
# ..... 
Dat23_model_fleetstruct_5_save <- Dat23_model_fleetstruct_5

#Fleet Number (Nfleets!=Nfleet; Nfleets=Nfleet+NSurvey)
Dat23_model_fleetstruct_5$Nfleets <- SS_Param2023$Nfleets$data$ThreeFleets_NoSlope_CombineTriennial		

#Fleets Info
Dat23_model_fleetstruct_5$fleetinfo <- SS_Param2023$fleet_info$data$ThreeFleets_NoSlope_CombineTriennial		

#Areas 
Dat23_model_fleetstruct_5$areas <- SS_Param2023$areas$data$ThreeFleets_NoSlope_CombineTriennial		

#catch /!\ Mismatch in the name of this variable - Upper vs Lower case
Dat23_model_fleetstruct_5$catch <- SS_Param2023$Catch$data$ThreeFleets_NoSlope_CombineTriennial		

#CPUE info
Dat23_model_fleetstruct_5$CPUEinfo <- SS_Param2023$CPUEinfo$data$ThreeFleets_NoSlope_CombineTriennial		

#CPUE
Dat23_model_fleetstruct_5$CPUE <- SS_Param2023$Indices$data$ThreeFleets_NoSlope_CombineTriennial		

#NB DISCARD FLEETS
Dat23_model_fleetstruct_5$N_discard_fleets <- SS_Param2023$N_discard_fleets$data$ThreeFleets_NoSlope_CombineTriennial		

# DISCARD info
Dat23_model_fleetstruct_5$discard_fleet_info <- SS_Param2023$discard_fleet_info$data$ThreeFleets_NoSlope_CombineTriennial		

# Discard rates /!\ Mismatch in the name of this variable - discard_data vs discard_rates
Dat23_model_fleetstruct_5$discard_data <- SS_Param2023$discard_rates$data$ThreeFleets_NoSlope_CombineTriennial		


# Discard mean indiv weight /!\ Mismatch in the name of this variable - Upper vs Lower case
Dat23_model_fleetstruct_5$meanbodywt <- SS_Param2023$Meanbodywt$data$ThreeFleets_NoSlope_CombineTriennial		

# Info on length composition
Dat23_model_fleetstruct_5$len_info <- SS_Param2023$len_info$data$ThreeFleets_NoSlope_CombineTriennial		

# Length composition - includes fisheries, surveys, landings, discards
Dat23_model_fleetstruct_5$lencomp <- SS_Param2023$All_LengthComp$data$ThreeFleets_NoSlope_CombineTriennial		

# Number of Fishing fleets
Dat23_model_fleetstruct_5$Nfleet <- SS_Param2023$Nfleet$data$ThreeFleets_NoSlope_CombineTriennial		

# Number of Surveys
Dat23_model_fleetstruct_5$Nsurveys <- SS_Param2023$Nsurveys$data$ThreeFleets_NoSlope_CombineTriennial		

#max_combined_lbin
Dat23_model_fleetstruct_5$max_combined_lbin <- Dat23_model_fleetstruct_5$max_combined_lbin[-grep("slope|Non.trawl_S", colnames(Dat23_model_fleetstruct_5_save$fleetinfo1))]
...
Ctl23_model_fleetstruct_5$size_selex_parms <- SS_Param2023$size_selex_parms$data$ThreeFleets_NoSlope_CombineTriennial	
Ctl23_model_fleetstruct_5$size_selex_parms_tv <- SS_Param2023$size_selex_parms_tv$data$ThreeFleets_NoSlope_CombineTriennial	

Ctl23_model_fleetstruct_5$Variance_adjustment_list <- SS_Param2023$Variance_adjustment_list$data$ThreeFleets_NoSlope_CombineTriennial	
...
# ..... 
# ..... 
new_max_totalcatch <- Fore23_model_fleetstruct_5$max_totalcatch_by_fleet
new_max_totalcatch[which(new_max_totalcatch$Fleet==3), "Max Catch"] <- sum(new_max_totalcatch[which(new_max_totalcatch$Fleet%in%c(3,4)), "Max Catch"])
new_max_totalcatch <- new_max_totalcatch[-which(new_max_totalcatch$Fleet==4),]
Fore23_model_fleetstruct_5$max_totalcatch_by_fleet <- new_max_totalcatch
...
# This can be done using the 5.2_Explore_FleetStructure_Outputs.R 
