...
RunSS_CtlFile(
  ...
  nameExe = "ss3_opt_win64.exe",
  # the .exe is in the oldSST_path directory
  pathExe = file.path(Exe_path, "SS_V3_24_U/SSv3.24U_Win64", fsep = .Platform$file.sep)
...
RunSS_CtlFile(
  ...
  isSSinPATH = FALSE,
  # the .exe is not declared in the PATH (for my machine)
  nameExe = "ss_win.exe" # I want to use this exe (windows OS)
)
# Read the model example control file
list.files(BaseMod_path)
Ctlfile <-
