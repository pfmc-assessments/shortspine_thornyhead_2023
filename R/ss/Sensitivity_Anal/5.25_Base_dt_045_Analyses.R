...
# /Users/jzahner/Desktop/shortspine_thornyhead_2023/R/ss/Sensitivity_Anal/5.25_Base_dt_045_Outputs.R 
...
Dir_23_base_dt_base_45 <- file.path(dir_SensAnal, '5.25_Decision_Table_045','1_23.base.dt_base_45' ,fsep = fsep)

# Add the model directory to the saved variables
var.to.save <- c(var.to.save, 'Dir_23_base_dt_base_45') 


# For each SS input file, the following variable names will be used:
# Starter file :			 Start23_base_dt_base_45 
# Data file :			 Dat23_base_dt_base_45 
# Control file :			 Ctl23_base_dt_base_45 
# Forecast file :			 Fore23_base_dt_base_45 
...
# ======================= #
# Read in the file
StarterFile <- file.path(Dir_23_base_dt_base_45, 'starter.ss', fsep = fsep)
Start23_base_dt_base_45 <- SS_readstarter(
      file = StarterFile,
      verbose = TRUE
      )
...
SS_writestarter(
      mylist =  Start23_base_dt_base_45 ,
      dir =  Dir_23_base_dt_base_45, 
      overwrite = TRUE,
      verbose = TRUE
      )

# Check file structure
# StarterFile <- file.path(Dir_23_base_dt_base_45, 'starter.ss')
#  Start23_base_dt_base_45 <- SS_readstarter(
      # file = StarterFile,
      # verbose = TRUE
      # )
...
# clean environment
var.to.save <- c(var.to.save, 'Start23_base_dt_base_45')
...
# ======================= #
# Read in the file
DatFile <-file.path(Dir_23_base_dt_base_45,Start23_base_dt_base_45$datfile, fsep = fsep)
Dat23_base_dt_base_45 <- SS_readdat_3.30(
      file = DatFile,
      verbose = TRUE,
      section = TRUE
      )
...
SS_writedat(
      datlist =  Dat23_base_dt_base_45 ,
      outfile = file.path(Dir_23_base_dt_base_45, 'SST_data.ss', fsep = fsep),
      version = '3.30',
      overwrite = TRUE
      )

# Check file structure
# DatFile <- file.path(Dir_23_base_dt_base_45, 'SST_data.ss', fsep = fsep)
#  Dat23_base_dt_base_45 <-
      # SS_readdat_3.30(
      # file = DatFile,
      # verbose = TRUE,
      # section = TRUE
...
# clean environment
var.to.save <- c(var.to.save, 'Dat23_base_dt_base_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# Read in the file
Ctlfile <-file.path(Dir_23_base_dt_base_45,Start23_base_dt_base_45$ctlfile, fsep = fsep)
Ctl23_base_dt_base_45 <- SS_readctl_3.30(
      file = Ctlfile,
      use_datlist = TRUE,
      datlist = file.path(Dir_23_base_dt_base_45, 'run','data_echo.ss_new', fsep = fsep),
      verbose = TRUE
      )
...
SS_writectl(
      ctllist =  Ctl23_base_dt_base_45 ,
      outfile = file.path(Dir_23_base_dt_base_45, 'SST_control.ss', fsep = fsep),
      version = '3.30',
      overwrite = TRUE
      )
# Check file structure
...
# clean environment
var.to.save <- c(var.to.save, 'Ctl23_base_dt_base_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# clean environment
var.to.save <- c(var.to.save, 'Fore23_base_dt_base_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# End development for model 23.base.dt_base_45 
# You can now develop the next 'new model'.
# Let's remove the input files for this from the 'var.to.save' variable
var.to.save <- var.to.save[!var.to.save %in% c('Start23_base_dt_base_45','Dat23_base_dt_base_45','Ctl23_base_dt_base_45','Fore23_base_dt_base_45')]
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
...
#  4. Developing model 23.base.dt_low_45  ----
# ----------------------------------------------------------- #

# Path to the 23.base.dt_low_45 repertory
Dir_23_base_dt_low_45 <- file.path(dir_SensAnal, '5.25_Decision_Table_045','2_23.base.dt_low_45' ,fsep = fsep)

# Add the model directory to the saved variables
var.to.save <- c(var.to.save, 'Dir_23_base_dt_low_45') 


# For each SS input file, the following variable names will be used:
# Starter file :					 Start23_base_dt_low_45 
# Data file :					 Dat23_base_dt_low_45 
# Control file :					 Ctl23_base_dt_low_45 
# Forecast file :					 Fore23_base_dt_low_45 
...
# ======================= #
# Read in the file
StarterFile <- file.path(Dir_23_base_dt_low_45, 'starter.ss', fsep = fsep)
Start23_base_dt_low_45 <- SS_readstarter(
      file = StarterFile,
      verbose = TRUE
      )
...
# Save the starter file for the model
SS_writestarter(
      mylist =  Start23_base_dt_low_45 ,
      dir =  Dir_23_base_dt_low_45, 
      overwrite = TRUE,
      verbose = TRUE
      )

# Check file structure
# StarterFile <- file.path(Dir_23_base_dt_low_45, 'starter.ss')
#  Start23_base_dt_low_45 <- SS_readstarter(
      # file = StarterFile,
      # verbose = TRUE
      # )
...
# clean environment
var.to.save <- c(var.to.save, 'Start23_base_dt_low_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# ======================= #
# Read in the file
DatFile <-file.path(Dir_23_base_dt_low_45,Start23_base_dt_low_45$datfile, fsep = fsep)
Dat23_base_dt_low_45 <- SS_readdat_3.30(
      file = DatFile,
      verbose = TRUE,
      section = TRUE
      )
...
# Save the data file for the model
SS_writedat(
      datlist =  Dat23_base_dt_low_45 ,
      outfile = file.path(Dir_23_base_dt_low_45, 'SST_data.ss', fsep = fsep),
      version = '3.30',
      overwrite = TRUE
      )

# Check file structure
# DatFile <- file.path(Dir_23_base_dt_low_45, 'SST_data.ss', fsep = fsep)
#  Dat23_base_dt_low_45 <-
      # SS_readdat_3.30(
      # file = DatFile,
      # verbose = TRUE,
      # section = TRUE
...
# clean environment
var.to.save <- c(var.to.save, 'Dat23_base_dt_low_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# Read in the file
Ctlfile <-file.path(Dir_23_base_dt_low_45,Start23_base_dt_low_45$ctlfile, fsep = fsep)
Ctl23_base_dt_low_45 <- SS_readctl_3.30(
      file = Ctlfile,
      use_datlist = TRUE,
      datlist = file.path(Dir_23_base_dt_low_45, 'run','data_echo.ss_new', fsep = fsep),
      verbose = TRUE
      )
...
# Save the control file for the model
SS_writectl(
      ctllist =  Ctl23_base_dt_low_45 ,
      outfile = file.path(Dir_23_base_dt_low_45, 'SST_control.ss', fsep = fsep),
      version = '3.30',
      overwrite = TRUE
      )
# Check file structure
...
# clean environment
var.to.save <- c(var.to.save, 'Ctl23_base_dt_low_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# clean environment
var.to.save <- c(var.to.save, 'Fore23_base_dt_low_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
run_SS(SS_version = '3.30.21',
      # version of SS
      base_path =Dir_23_base_dt_low_45,
      # root directory where the input file are housed
      pathRun = NULL,
      # A 'run' folder is created if needed (where output files will be stored)
      copy_files = TRUE,
      # copy the input files from the23.base.dt_low_45folder
      cleanRun = TRUE,
      # clean the folder after the run
...
# End development for model 23.base.dt_low_45 
# You can now develop the next 'new model'.
# Let's remove the input files for this from the 'var.to.save' variable
var.to.save <- var.to.save[!var.to.save %in% c('Start23_base_dt_low_45','Dat23_base_dt_low_45','Ctl23_base_dt_low_45','Fore23_base_dt_low_45')]
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
...
#  5. Developing model 23.base.dt_high_45  ----
# ----------------------------------------------------------- #

# Path to the 23.base.dt_high_45 repertory
Dir_23_base_dt_high_45 <- file.path(dir_SensAnal, '5.25_Decision_Table_045','3_23.base.dt_high_45' ,fsep = fsep)

# Add the model directory to the saved variables
var.to.save <- c(var.to.save, 'Dir_23_base_dt_high_45') 


# For each SS input file, the following variable names will be used:
# Starter file :			 Start23_base_dt_high_45 
# Data file :			 Dat23_base_dt_high_45 
# Control file :			 Ctl23_base_dt_high_45 
# Forecast file :			 Fore23_base_dt_high_45 
...
# ======================= #
# Read in the file
StarterFile <- file.path(Dir_23_base_dt_high_45, 'starter.ss', fsep = fsep)
Start23_base_dt_high_45 <- SS_readstarter(
      file = StarterFile,
      verbose = TRUE
      )
...
# Save the starter file for the model
SS_writestarter(
      mylist =  Start23_base_dt_high_45 ,
      dir =  Dir_23_base_dt_high_45, 
      overwrite = TRUE,
      verbose = TRUE
      )

# Check file structure
# StarterFile <- file.path(Dir_23_base_dt_high_45, 'starter.ss')
#  Start23_base_dt_high_45 <- SS_readstarter(
      # file = StarterFile,
      # verbose = TRUE
      # )
...
# clean environment
var.to.save <- c(var.to.save, 'Start23_base_dt_high_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# ======================= #
# Read in the file
DatFile <-file.path(Dir_23_base_dt_high_45,Start23_base_dt_high_45$datfile, fsep = fsep)
Dat23_base_dt_high_45 <- SS_readdat_3.30(
      file = DatFile,
      verbose = TRUE,
      section = TRUE
      )
...
# Save the data file for the model
SS_writedat(
      datlist =  Dat23_base_dt_high_45 ,
      outfile = file.path(Dir_23_base_dt_high_45, 'SST_data.ss', fsep = fsep),
      version = '3.30',
      overwrite = TRUE
      )

# Check file structure
# DatFile <- file.path(Dir_23_base_dt_high_45, 'SST_data.ss', fsep = fsep)
#  Dat23_base_dt_high_45 <-
      # SS_readdat_3.30(
      # file = DatFile,
      # verbose = TRUE,
      # section = TRUE
...
# clean environment
var.to.save <- c(var.to.save, 'Dat23_base_dt_high_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# Read in the file
Ctlfile <-file.path(Dir_23_base_dt_high_45,Start23_base_dt_high_45$ctlfile, fsep = fsep)
Ctl23_base_dt_high_45 <- SS_readctl_3.30(
      file = Ctlfile,
      use_datlist = TRUE,
      datlist = file.path(Dir_23_base_dt_high_45, 'run','data_echo.ss_new', fsep = fsep),
      verbose = TRUE
      )
...
# Save the control file for the model
SS_writectl(
      ctllist =  Ctl23_base_dt_high_45 ,
      outfile = file.path(Dir_23_base_dt_high_45, 'SST_control.ss', fsep = fsep),
      version = '3.30',
      overwrite = TRUE
      )
# Check file structure
...
# clean environment
var.to.save <- c(var.to.save, 'Ctl23_base_dt_high_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# clean environment
var.to.save <- c(var.to.save, 'Fore23_base_dt_high_45')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
run_SS(SS_version = '3.30.21',
      # version of SS
      base_path =Dir_23_base_dt_high_45,
      # root directory where the input file are housed
      pathRun = NULL,
      # A 'run' folder is created if needed (where output files will be stored)
      copy_files = TRUE,
      # copy the input files from the23.base.dt_high_45folder
      cleanRun = TRUE,
      # clean the folder after the run
...
# This can be done using the 5.25_Base_dt_045_Outputs.R script.
