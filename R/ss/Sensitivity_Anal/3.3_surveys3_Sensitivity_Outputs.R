...
SA_path <- file.path('model','Sensitivity_Anal','3.3_surveys3_Sensitivity',fsep = fsep)
# Path to the 23.surveys.useslope repertory
Dir_23_surveys_useslope <- file.path(dir_SensAnal, '3.3_surveys3_Sensitivity','1_23.surveys.useslope' , 'run',fsep = fsep)

# Path to the 23.surveys.extaSDwcgbts repertory
Dir_23_surveys_extaSDwcgbts <- file.path(dir_SensAnal, '3.3_surveys3_Sensitivity','2_23.surveys.extaSDwcgbts' , 'run',fsep = fsep)

# Path to the 23.surveys.notriennial repertory
Dir_23_surveys_notriennial <- file.path(dir_SensAnal, '3.3_surveys3_Sensitivity','3_23.surveys.notriennial' , 'run',fsep = fsep)

# Extract the outputs for all models
SensiMod <- SSgetoutput(dirvec = c(
	Dir_23_model_francis_2,
	Dir_23_surveys_useslope,
	Dir_23_surveys_extaSDwcgbts,
	Dir_23_surveys_notriennial))
