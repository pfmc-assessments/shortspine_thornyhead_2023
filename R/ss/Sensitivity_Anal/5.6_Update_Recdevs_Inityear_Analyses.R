...
# 	- Modify recdev init year 
# Author:  Team Thornyheads 
# Date: 2023-04-27 12:16:32 
# Name of the model created: 23.model.recdevs_inityear_1996 
# *** 
# 
...
#	 C:/Users/pyher/Documents/shortspine_thornyhead_2023/model/Sensitivity_Anal/5.6_Update_Recdevs_Inityear 
# 
# Features: 
Update the initial year for recdevs 1996 
# ============================================================ #
...
# C:/Users/pyher/Documents/shortspine_thornyhead_2023/R/ss/Sensitivity_Anal/5.6_Update_Recdevs_Inityear_Outputs.R 
...
# won't be estimated.
# Reminder - The following models are considered:# 	-  23.model.recdevs_inityear_1996 
noHess <- c(TRUE)
...
#  3. Developing model 23.model.recdevs_inityear_1996  ----
# ----------------------------------------------------------- #

# Path to the 23.model.recdevs_inityear_1996 repertory
Dir_23_model_recdevs_inityear_1996 <- file.path(dir_SensAnal, '5.6_Update_Recdevs_Inityear','1_23.model.recdevs_inityear_1996' ,fsep = fsep)

# Add the model directory to the saved variables
var.to.save <- c(var.to.save, 'Dir_23_model_recdevs_inityear_1996') 


# For each SS input file, the following variable names will be used:
# Starter file :			 Start23_model_recdevs_inityear_1996 
# Data file :			 Dat23_model_recdevs_inityear_1996 
# Control file :			 Ctl23_model_recdevs_inityear_1996 
# Forecast file :			 Fore23_model_recdevs_inityear_1996 
...
# ======================= #
# Read in the file
StarterFile <- file.path(Dir_23_model_recdevs_inityear_1996, 'starter.ss', fsep = fsep)
Start23_model_recdevs_inityear_1996 <- SS_readstarter(
      file = StarterFile,
      verbose = TRUE
      )
...
# SS_writestarter(
      # mylist =  Start23_model_recdevs_inityear_1996 ,
      # dir =  Dir_23_model_recdevs_inityear_1996, 
      # overwrite = TRUE,
      # verbose = TRUE
      # )

# Check file structure
# StarterFile <- file.path(Dir_23_model_recdevs_inityear_1996, 'starter.ss')
#  Start23_model_recdevs_inityear_1996 <- SS_readstarter(
      # file = StarterFile,
      # verbose = TRUE
      # )
...
# clean environment
var.to.save <- c(var.to.save, 'Start23_model_recdevs_inityear_1996')
...
# ======================= #
# Read in the file
DatFile <-file.path(Dir_23_model_recdevs_inityear_1996,Start23_model_recdevs_inityear_1996$datfile, fsep = fsep)
Dat23_model_recdevs_inityear_1996 <- SS_readdat_3.30(
      file = DatFile,
      verbose = TRUE,
      section = TRUE
      )
...
# SS_writedat(
      # datlist =  Dat23_model_recdevs_inityear_1996 ,
      # outfile = file.path(Dir_23_model_recdevs_inityear_1996, 'SST_data.ss', fsep = fsep),
      # version = '3.30',
      # overwrite = TRUE
      # )

# Check file structure
# DatFile <- file.path(Dir_23_model_recdevs_inityear_1996, 'SST_data.ss', fsep = fsep)
#  Dat23_model_recdevs_inityear_1996 <-
      # SS_readdat_3.30(
      # file = DatFile,
      # verbose = TRUE,
      # section = TRUE
...
# clean environment
var.to.save <- c(var.to.save, 'Dat23_model_recdevs_inityear_1996')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# Read in the file
Ctlfile <-file.path(Dir_23_model_recdevs_inityear_1996,Start23_model_recdevs_inityear_1996$ctlfile, fsep = fsep)
Ctl23_model_recdevs_inityear_1996 <- SS_readctl_3.30(
      file = Ctlfile,
      use_datlist = TRUE,
      datlist = file.path(Dir_23_model_recdevs_inityear_1996, 'run','data_echo.ss_new', fsep = fsep),
      verbose = TRUE
      )
...
Ctl23_model_recdevs_inityear_1996$MainRdevYrFirst <- 1996 

# Save the control file for the model
SS_writectl(
       ctllist =  Ctl23_model_recdevs_inityear_1996 ,
       outfile = file.path(Dir_23_model_recdevs_inityear_1996, 'SST_control.ss', fsep = fsep),
       version = '3.30',
       overwrite = TRUE
       )
# Check file structure
...
# clean environment
var.to.save <- c(var.to.save, 'Ctl23_model_recdevs_inityear_1996')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
# Read in the file
ForeFile <- file.path(Dir_23_model_recdevs_inityear_1996, 'forecast.ss', fsep = fsep)
Fore23_model_recdevs_inityear_1996 <-SS_readforecast(
      file = ForeFile,
      version = '3.30',
      verbose = T,
      readAll = T
...
# SS_writeforecast(
      # mylist =  Fore23_model_recdevs_inityear_1996 ,
      # dir = Dir_23_model_recdevs_inityear_1996, 
      # file = 'forecast.ss',
      # writeAll = TRUE,
      # verbose = TRUE,
...
# clean environment
var.to.save <- c(var.to.save, 'Fore23_model_recdevs_inityear_1996')
rm(list = setdiff(ls(), var.to.save))
var.to.save <- ls()
# =======================
...
Dirplot <- file.path(Dir_23_model_recdevs_inityear_1996, 'run', fsep = fsep)
