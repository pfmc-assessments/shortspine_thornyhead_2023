...
#   column_spec(c(1,3,5,7,9), extra_css = "border-right: 1.5px solid black") %>%
#   column_spec(1, extra_css = "border-left: 1.5px solid black")  %>%
#   collapse_rows(columns = 1, valign = "middle") %>%
#   row_spec(13, extra_css = "border-top: 1.5px solid;")
# 
# sa4ss::table_format(x = dt,
#                   caption = "Decision table showing spawning output (SO) and depletion (dep) under full ACL attainment and two different P* values through 2034.",
#                   label = "dtES")
