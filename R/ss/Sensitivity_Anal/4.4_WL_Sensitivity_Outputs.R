...
SA_path <- file.path('model','Sensitivity_Anal','STAR_Panel','4.4_WL_Sensitivity',fsep = fsep)

# Path to the 23.WL.sensitivity repertory
Dir_23_WL_sensitivity <- file.path(dir_SensAnal, '4.4_WL_Sensitivity','1_23.WL.sensitivity' , 'run',fsep = fsep)

# Extract the outputs for all models
SensiMod <- SSgetoutput(dirvec = c(
	Dir_23_model_francis_2,
	Dir_23_WL_sensitivity))
