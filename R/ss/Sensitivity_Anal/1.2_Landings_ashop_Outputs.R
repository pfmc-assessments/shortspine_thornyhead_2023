...
SA_path <- file.path('model','Sensitivity_Anal','1.2_Landings_ashop',fsep = fsep)
# Path to the 23.landings.ashop repertory
Dir_23_landings_ashop <- file.path(dir_SensAnal, '1.2_Landings_ashop','1_23.landings.ashop' , 'run',fsep = fsep)

# Extract the outputs for all models
SensiMod <- SSgetoutput(dirvec = c(
	Dir_23_model_francis_2,
	Dir_23_landings_ashop))
