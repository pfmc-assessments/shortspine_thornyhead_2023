...
## This is the same plot_comps function as in the nwfscSurvey
## package. The official one has a bug that prevents the plots
## from being generated. An issue was submitted on GitHub on
## 01/31/23.
