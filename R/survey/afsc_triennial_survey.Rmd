...
No clear CPUE trend over time across Latitude, though CPUE map clearly shows that effort in early years was concentrated in Washingoyon an Orgeon, and effort only equalized into California in later years. There is a clear positive correlation between CPUE and Depth, with larger depths consistebtly receiving additional effort. It also appears that surveys performed pre 1992, had a maximum depth of ~400m, before the survey was extended to 500m.
